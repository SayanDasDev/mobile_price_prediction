...
We finally selected \textbf{Logistic Regression} as the best model due to its consistent high performance across all metrics, including accuracy, precision, recall, and F1-score. Also it being a simple model, takes less time to train.
