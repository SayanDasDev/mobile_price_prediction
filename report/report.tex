...
\end{enumerate}
The initial configurations resulted in good training accuracy but some inconsistencies in test performance.
\begin{table}[H]
    \centering
...
\end{enumerate}
As we can see there are overfitting issues with some models. We will use \pythoninline{GridSearchCV} to tune the hyperparameters to get better performance.
